            ...
            <div class="border-b border-gray-200">
              <div class="h-16 flex items-center justify-between">
                  ...
                  <PopoverGroup class="px-4 bottom-0 inset-x-0">
                    <div class="h-full flex justify-center space-x-8 space-x-reverse">
                      ...
                      <router-link  to="/" class="my-auto justify-center items-center text-center self-center">
                        ...
                        <img class="h-40 w-auto sm:h-10" src="~/assets/pic/logo.png" alt="" />
                      </router-link>
                ...
                <router-link to="/" class="lg:hidden">
                  ...
                  <img src="~/assets/pic/logo.png" alt="" class="h-12 w-auto" />
                </router-link>
      ...
      featured: [
        {
          name: 'شال پوست ماری',
          href: '/shop',
          imageSrc: 'https://nuxt.markazimarket.com/public/storage/product/11042345975840',
          imageAlt: 'شال پوست ماری.',
        },
        {
          name: 'شال برند',
          href: '#',
          imageSrc: 'https://nuxt.markazimarket.com/public/storage/product/12042348939131',
          imageAlt: 'شال برند.',
        },
        {
          name: 'شال بته جقه',
          href: '#',
          imageSrc: 'https://nuxt.markazimarket.com/public/storage/product/12042326377987',
          imageAlt: 'شال بته چقه.',
        },
        {
          name: 'شال ابریشمی',
          href: '#',
      ...
      featured: [
        {
          name: 'روسری ابریشمی',
          href: '#',
          imageSrc: 'https://nuxt.markazimarket.com/public/storage/product/12042342127745',
          imageAlt: 'Hats and sweaters on wood shelves next to various colors of t-shirts on hangers.',
        },
        {
          name: 'روسری چهارفصل',
          href: '#',
          imageSrc: 'https://nuxt.markazimarket.com/public/storage/product/150423023213',
          imageAlt: 'Model wearing light heather gray t-shirt.',
        },
        {
          name: 'باندانا',
          href: '#',
          imageSrc: 'https://nuxt.markazimarket.com/public/storage/product/21042424611859',
          imageAlt:
